...
<body>
    <div class="main-container">
                ...
                while ($row = mysqli_fetch_assoc($result)) {
                    if (!empty($row)) {
                        ...
                        <div class="car-box">
                            ...
                            <a href="coches-borrar3.php?id_coche=<?php echo $row['id_coche'];?>" class="button">Borrar</a>
                        </div>
                        <?php
                    }
                }
        ...
        <div class="button-container">
            <a href="/PracticaConcesionario/coches/coches-borrar.php" class="button">Volver atras</a>
        </div>
    </div>
</body>
</html>
